...
export default function AboutUs() {
  return (
    <>
      <div id="home" className="bg-[url('./assets/images/aboutbg.png')] bg-cover bg-center h-screen relative">
        {/* Top center image */}
        ...
        <div className="absolute left-4 sm:left-8 top-[35%] sm:top-[45%] text-white max-w-xs sm:max-w-lg">
          <h2 className="text-2xl sm:text-4xl font-bold leading-tight text-center sm:text-left">
            We Provide You The Best <br /> Srilankan Sightseeing Tours
          </h2>
          <p className="mt-2 sm:mt-4 text-sm sm:text-lg text-center sm:text-left">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>

          <button className="bg-[#DF6951] text-white px-4 py-2 rounded-full hover:bg-[#D56C4C] transition duration-300 mt-4">
            View Packages
          </button>
        ...
        {/* Right center image */}
        <div className="absolute top-[50%] sm:top-[65%] right-2 sm:right-4 transform -translate-y-1/2">
