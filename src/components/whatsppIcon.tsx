...
export default function WhatsAppIcon() {
  const handleWhatsAppClick = () => {
    const phoneNumber = "+94702992332"; // Replace with your WhatsApp number
  ...
  return (
    <div
      ...
      className="fixed bottom-4 right-4 bg-green-500 hover:bg-green-600 text-white p-2 rounded-full shadow-lg cursor-pointer flex items-center justify-center animate-bounce"
    >
      {/* Icon */}
